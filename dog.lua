...
local Window = Library.CreateLib(" sleaqse my goat | Mitaki |", "GrapeTheme")
...
BSection:NewToggle("Auto Collect Stars,3", "Continuously collects Stars and Blue Stars", function(state)
